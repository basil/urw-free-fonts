...
URW released several free fonts [for use with TeX](https://ctan.org/tex-archive/fonts/urw).
...
$ ls dist/*.zip
dist/A030.zip
dist/GaramondNo8.zip
dist/LetterGothic.zip
dist/URWAntiquaT.zip
dist/URWClassico.zip
dist/URWGroteskT.zip
```
